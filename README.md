...
- **[ContextZip](https://github.com/jee599/contextzip)** `⭐ 1` — CLI output compressor for coding agents; reduces token waste by 60-90% with 6 noise filters (error stacktraces, ANSI codes, build logs, package install, Docker, web pages). Fork of RTK. MIT.
