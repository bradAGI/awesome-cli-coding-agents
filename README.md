...
- **[Cynative](https://github.com/cynative/cynative)** `⭐ 2` - Agentic security CLI that runs code in a built-in sandbox to research AWS, GCP, Azure, Kubernetes, GitHub and GitLab. Read-only enforced by default.
