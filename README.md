...
- **[Cognitropy Lab](https://github.com/DaxxSec/cognitropy-lab)** `⭐ 1` — Autonomous workspace factory that builds one Claude Agent Workspace daily using a date-seeded entropy engine (363 domains, 18.8M unique outcomes). Full pipeline: domain assignment → workspace build → secrets scan → push. MIT.
