...
- **[Agent Island](https://github.com/tristan666666/agent-island)** `⭐ 110` — Local status companion for Claude Code and Codex on macOS and Windows. macOS also shows Antigravity and Grok session state and tracks usage for those providers plus Cursor. MIT.
