...
- **[Podium ADE](https://github.com/madeinorbit/podium)** `⭐ 22` — An open-source workspace for taking your ideas from conversation to coordinated work with coding agents. A shared task system lets them organize the effort while you follow progress, discuss decisions, and change direction as the work develops. Desktop, web, and CLI; local or VPS. Apache-2.0.
