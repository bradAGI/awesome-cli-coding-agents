...
- **[zot](https://github.com/patriceckhart/zot)** `⭐ 1` — Zero-overhead and lightweight coding agent harness with TUI/JSON/RPC modes, structured tools, reviewable file diffs, skills, extensions, and optional guardrails.
